...
- The setup screen defers Phaser until Start challenge. Initial JavaScript is 12.21 kB gzip; the deferred Phaser/game chunk is 338.70 kB gzip and still produces a Vite size advisory. See the [measured performance decision](docs/performance-decisions.md).
